...
const translations = {
  en: {
    ...
    mouse_slide3_text: "Once focused, <strong>long press the mouse button on the album card for 2 seconds</strong>. Wait for the circular ring to load, and the record will fly into the turntable!",
  ...
  zh: {
    ...
    mouse_slide3_text: "聚焦后，<strong>在唱片上长按鼠标左键保持 2 秒钟</strong>。等待进度圈加载完毕，唱片就会飞入唱机开始播放！",
