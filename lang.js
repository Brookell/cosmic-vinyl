...
const translations = {
  en: {
    ...
    save_prompt_body: "Add this track to your own music space.",
    ...
    try_add_favorite: "This is the public space. Add a favorite song or tap + to create your own.",
    all: "All",
    gestures: "Gestures",
  ...
  zh: {
    ...
    save_prompt_body: "加入自己的音乐空间，只留下你喜欢的歌。",
    ...
    try_add_favorite: "这里是公共空间。加入喜欢的歌曲，或点击 + 创建自己的空间。",
    all: "全部",
    gestures: "手势",
    search_online: "在线搜索",
    search_songs: "搜索歌曲...",
